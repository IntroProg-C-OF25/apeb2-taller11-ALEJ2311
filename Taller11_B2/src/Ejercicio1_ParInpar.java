...
public class Ejercicio1_ParInpar {
        
    public static void main(String[] args) {
        Scanner tcl = new Scanner(System.in);
        int limFilas = 0, limColumnas = 0;
        System.out.print("DEME EL LIMITE DE FILAS Y COLUMNAS DE LA MATRIZ: ");
...
/***
 * run:
 * DEME EL LIMITE DE FILAS Y COLUMNAS DE LA MATRIZ: 2 3
 * MATRIZ GENERADA
 * 5 8 6 
 * 2 8 0 
